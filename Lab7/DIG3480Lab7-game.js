...
specialCoin.prototype.type = "specialCoin";
...
var specialCoinReactSpeed = 10, specialCoinReactDist = 0.09;
	
specialCoin.prototype.act = function(step) {
	this.react += step * specialCoinReactSpeed;
	var reactPos = Math.sin(this.react) + specialCoinReactDist;
	this.pos = this.basePos.plus(new Vector(0, reactPos));
};
